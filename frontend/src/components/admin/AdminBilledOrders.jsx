    ...
    return (
        <div className="flex flex-col h-full animate-in fade-in duration-700 font-sans pb-24">
            ...
            <div className="flex-1 px-10 overflow-y-auto no-scrollbar">
                <div className="grid grid-cols-1 sm:grid-cols-[repeat(auto-fill,minmax(320px,1fr))] gap-8 pb-12">
                    {displaySessions.map((session) => (
                        <div key={session.tableId} className="bg-white/5 border border-white/10 rounded-[2rem] p-8 flex flex-col shadow-2xl relative h-[480px] overflow-hidden">
