...
export const menuData = [
    // Non Veg Starters
    { id: 'nvs1', name: 'CHICKEN 65', price: 9.99, category: 'Non Veg Starters', spice: 2, veg: false },
    { id: 'nvs2', name: 'CHILLI CHICKEN', price: 9.99, category: 'Non Veg Starters', spice: 3, veg: false },
    { id: 'nvs3', name: 'CHICKEN MAJESTIC', price: 11.99, category: 'Non Veg Starters', spice: 2, veg: false },
    { id: 'nvs4', name: 'CHICKEN TIKKA KEBAB (4 PCS)', price: 11.99, category: 'Non Veg Starters', spice: 2, veg: false },
    { id: 'nvs5', name: 'CHICKEN SEEKH KEBAB (4 PCS)', price: 10.99, category: 'Non Veg Starters', spice: 2, veg: false },
    { id: 'nvs6', name: 'PEPPER CHICKEN', price: 11.99, category: 'Non Veg Starters', spice: 3, veg: false },
    { id: 'nvs7', name: 'CHICKEN TANDOORI FULL', price: 14.99, category: 'Non Veg Starters', spice: 2, veg: false },
    { id: 'nvs8', name: 'CHICKEN TANDOORI HALF', price: 9.99, category: 'Non Veg Starters', spice: 2, veg: false },
    { id: 'nvs9', name: 'CHICKEN TANGDI (4 PCS)', price: 9.99, category: 'Non Veg Starters', spice: 2, veg: false },
    { id: 'nvs10', name: 'LAMB SEEKH KEBAB (4 PCS)', price: 11.99, category: 'Non Veg Starters', spice: 2, veg: false },
    { id: 'nvs11', name: 'LAMB CHOPS (4 PCS)', price: 12.99, category: 'Non Veg Starters', spice: 2, veg: false },
    { id: 'nvs12', name: 'MUTTON HALEEM', price: 14.99, category: 'Non Veg Starters', spice: 1, veg: false },
    { id: 'nvs13', name: 'MUTTON MARAG', price: 14.99, category: 'Non Veg Starters', spice: 1, veg: false },

    // Sea Food
    { id: 'sf1', name: 'MASALA FISH (1 PC)', price: 7.99, category: 'Sea Food', spice: 2, veg: false },
    { id: 'sf2', name: 'APOLLO FISH', price: 14.99, category: 'Sea Food', spice: 2, veg: false },
    { id: 'sf3', name: 'TANDOORI GRILLED FISH', price: 14.99, category: 'Sea Food', spice: 2, veg: false },
    ...
    // Biryani Thaali
    { id: 'bt1', name: 'THAALI FOR 2 (LAMB)', price: 29.99, category: 'Biryani Thaali', desc: '1 Double Biryani, Chicken 65, Chilli Chicken, 1 Pc Tandoori, 1 Naan, 1 Rumali, 2 Drinks', spice: 2, veg: false, group: 2 },
    { id: 'bt2', name: 'THAALI FOR 2 (CHICKEN)', price: 25.99, category: 'Biryani Thaali', desc: '1 Double Biryani, Chicken 65, Chilli Chicken, 1 Pc Tandoori, 1 Naan, 1 Rumali, 2 Drinks', spice: 2, veg: false, group: 2 },
    { id: 'bt3', name: 'THAALI FOR 4 (LAMB)', price: 59.99, category: 'Biryani Thaali', desc: '2 Double Biryani, 2 Pc Tandoori, 2 Naan, 2 Rumali, 4 Drinks', spice: 2, veg: false, group: 4 },
    { id: 'bt4', name: 'THAALI FOR 4 (CHICKEN)', price: 54.99, category: 'Biryani Thaali', desc: '2 Double Biryani, 2 Pc Tandoori, 2 Naan, 2 Rumali, 4 Drinks', spice: 2, veg: false, group: 4 },
